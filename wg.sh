...
iptables -I INPUT 1 -i $SERVER_PUB_NIC -p udp --dport 1418 -j ACCEPT
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/Dimas1441/error1/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/Dimas1441/error1/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/Dimas1441/error1/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/Dimas1441/error1/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
