...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/Dimas1441/error1/main/accel.conf"
...
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 1420 -j ACCEPT
iptables -I INPUT -m state --state NEW -m udp -p udp --dport 1420 -j ACCEPT
iptables-save > /etc/iptables.up.rules
iptables-restore -t < /etc/iptables.up.rules
netfilter-persistent save > /dev/null
netfilter-persistent reload > /dev/null
#input perintah sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/Dimas1441/error1/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://raw.githubusercontent.com/Dimas1441/error1/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://raw.githubusercontent.com/Dimas1441/error1/main/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://raw.githubusercontent.com/Dimas1441/error1/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
